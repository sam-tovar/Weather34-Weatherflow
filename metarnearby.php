...
<head>
 ...
 <style>
@font-face{font-family:weathertext;src:url(css/fonts/verbatim-regular.woff) format("woff")}*,*:before,*:after{-webkit-box-sizing:border-box;box-sizing:border-box;margin:0;padding:0}html,body{font-size:62.5%;font-family:"weathertext",Helvetica, Arial, sans-serif;background:rgba(11, 12, 12, 0.4); background-repeat:no-repeat}body{color:#aaa;overflow-x:hidden;min-height:80vh;padding:10px}
...
<div class="icon"><span style="position:absolute;margin-top:-12px;width:74px;">Metar Data Provided by </span><a href="https://www.checkwx.com/weather/<?php echo $icao1;?>" title="https://www.checkwx.com/weather/<?php echo $icao1;?>" target="_blank"><img src=img/checkwx.svg width=80px alt="https://www.checkwx.com/weather/<?php echo $icao1;?>"></a></div>
</section>
<div class="provided"> 
