...
$darkskyunit   = "si";
$wuapiunit   = "m";
$stationlocation = " METEOBRIDGE Weatherflow";
$stationName = "Weatherflow DEMO";
$moonadj = "0";
$minmag = "3";
$unit = "metric";
$metric = true;
...
$position3title   = "Annual Hi-Lo <red>Temperatures </red>";
$position4title   = "Advisory";
...
$weatherhardware   = "Weatherflow Air-Sky(Solar)";
$mbplatform   = "MB TP-Link";
