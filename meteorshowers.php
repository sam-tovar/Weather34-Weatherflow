...
.weather34meteorcircle {  position: absolute;  width: 125px;  height: 125px;  top: 15px;  left: 80px;  background:#cf5129;border-radius: 50%;  overflow: hidden;  z-index:-1;
}
...
<body>
<div class="weather34darkbrowser" url="<?php echo date('Y')?> Annual Active Meteor Showers "></div> 
...
<section class="weather34cards">
   <div class="weather34card weather34card--earthquake1">
               <div class="weather34card_weather34-container">
            <div class="weather34card_weather34-wrapper"><span class="weather34card__count-text--bigsa" style="font-size:10px;">
        <?php echo $info ;?> <orange>Guide to</orange> <green><?php echo date('Y');?> Major Meteor Showers</green> <br>
