...
<?php //WEATHER34 AIR QAULITY VALUE 
 if ($aqiweather["aqi"] >300){echo "<airvalue><indoorred>",$aqiweather["aqi"] ; }
 else if ($aqiweather["aqi"] >200){echo "<airvalue><indoorpurple>",$aqiweather["aqi"] ;}
 else if ($aqiweather["aqi"] >150){echo "<airvalue><indoorred>",$aqiweather["aqi"] ;}
 else if ($aqiweather["aqi"] >100){echo "<airvalue><indoororange>",$aqiweather["aqi"] ;}
 else if ($aqiweather["aqi"] >50){echo "<airvalue0><indooryellow>&nbsp; &nbsp;",$aqiweather["aqi"] ;}
 else if ($aqiweather["aqi"] >=0){echo "<airvalue0><indoorgreen>&nbsp; &nbsp;",$aqiweather["aqi"] ;}
