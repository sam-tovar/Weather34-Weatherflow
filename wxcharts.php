...
<!--Insert link to pop up module here-->
         <a rel='prefetch' href="http://www.meteociel.fr/modeles/ecmwf/runs/<?php echo date('Ymd')?>00/ECM0-0.GIF" data-lity style="margin-left:0;text-transform:uppercase !important;" >
 <!--end Insert link to pop up module here-->  
  ...
  <!--Insert link to pop up module here-->
         <a rel='prefetch' href="http://modeles.meteociel.fr/modeles/gfs/runs/<?php echo date('Ymd')?>00/gfs-2-18.png" data-lity style="margin-left:0;text-transform:uppercase !important;">
	<!-- end Insert link to pop up module here-->	
  ...
  <div class="weather-item">
   <div class="chartforecast">
      ...
      <!--Insert link to pop up module here--> 
       <a rel='prefetch' href="https://www.mgm.gov.tr/FTPDATA/uzal/radar/ist/istmax15.jpg" data-lity style="margin-left:0;text-transform:uppercase !important;">
	  <!--end Insert link to pop up module here--> 
...
<div class="weather-container">
  ...
  <div class="chartforecast">
  <!--Insert link to pop up module here-->
   <a rel='prefetch' href="https://www.windy.com/?clouds,<?php echo $lat ;?>,<?php echo $lon ;?>,8" data-lity style="margin-left:0;text-transform:uppercase !important;">
	<!--end Insert link to pop up module here-->	 
  ...
  <div class="weather-item">
   ...
   <!--Insert link to pop up module here-->
         <a rel='prefetch' href="https://www.windy.com/?rain,<?php echo $lat ;?>,<?php echo $lon ;?>,8" data-lity style="margin-left:0;text-transform:uppercase !important;">
	<!--end Insert link to pop up module here-->	 
  ...
  <!--Insert link to pop up module here-->
  <a rel='prefetch' href="https://www.windy.com/?temp,<?php echo $lat ;?>,<?php echo $lon ;?>,8" data-lity style="margin-left:0;text-transform:uppercase !important;">  
  <!--end Insert link to pop up module here-->
...
<div class="weather-container">
  ...
  <!--Insert link to pop up module here-->
         <a rel='prefetch' href="http://wxcharts.eu/charts/arpege/europe/00/850temp_003.jpg?<?php echo date('Ymd')?>00" data-lity style="margin-left:0;text-transform:uppercase !important;">
	<!--end Insert link to pop up module here-->	 
  ...
  <!--Insert link to pop up module here-->  
    <a rel='prefetch' href="http://wxcharts.eu/charts/gfs/europe/00/850temp_anom_024.jpg?<?php echo date('Ymd')?>00" data-lity style="margin-left:0;text-transform:uppercase !important;">
  <!--end Insert link to pop up module here-->  
 ...
 <!--end Insert link to source image or iframe-->
  ...
  <!--Insert link to pop up module here-->
        <a rel='prefetch' href="img/iframe.jpg" width="775px" height="420px" data-lity style="margin-left:0;text-transform:uppercase !important;">
